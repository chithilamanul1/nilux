    ...
    <section className="relative w-full bg-[#fcfaff] pt-36 pb-24 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          ...
          Better <span className="font-vine font-normal text-[0.9em] sm:text-[1.1em] md:text-[1.4em] text-[var(--nilux-violet)] pr-2 relative top-2 inline-block mt-2 md:mt-0">Businesses</span>
        </motion.h1>
